 ...
 */
class OrgThreeFactorsByAccount extends EsignRequest implements \JsonSerializable
{
    private $accountId;
    ...
    /**
     * OrgThreeFactorsByAccount constructor.
     * @param $accountId
    ...
    function build()
    {
        $this->setUrl("/v2/identity/auth/api/organization/".$this->accountId."/threeFactors");
