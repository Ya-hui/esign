 ...
 */
class QryTransferProcess extends EsignRequest implements \JsonSerializable
{
    private $flowId;

    /**
     * QryTransferProcess constructor.
     * @param $flowId
     */
    ...
    function build()
    {
        $this->setUrl("/v2/identity/auth/pub/organization/".$this->flowId."/transferProcess");
